...
DIRECTIV := -DEZX_E8 -DFixByQT -DNEW_PLATFORM -DHARD_KEY_DAEMON -DFIX_MENU_1 -DRAISE_PHONE -DFLOWPLAYER
TARGET	=       $(APPNAME)_E8
endif
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_EM30 -DEZX_E8 -DFixByQT -DNEW_PLATFORM -DHARD_KEY_DAEMON -DRAISE_PHONE -DFLOWPLAYER
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_U9 -DFixByQT -DFIX_FORMCONTAINER -DFIX_MENU_2 -DRAISE_PHONE
TARGET	=       $(APPNAME)_U9
endif
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_Z6W -DFixByQT -DFIX_FORMCONTAINER -DFIX_MENU_2 -DRAISE_PHONE
TARGET	=       $(APPNAME)_Z6W
endif
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_ZN5 -DFixByQT -DFIX_FORMCONTAINER -DHARD_KEY_DAEMON -DFIX_MENU_2 -DRAISE_PHONE
TARGET	=       $(APPNAME)_ZN5
endif
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_EM35 -DFixByQT -DNEW_PLATFORM -DES_EVENT -DNEW_JAVA_LIST
#-DSWITCH_BY_UID
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_VE66 -DFixByQT -DNEW_PLATFORM -DES_EVENT -DNEW_JAVA_LIST
#-DSWITCH_BY_UID
...
ifeq ($(ALLVISIBLEINFOBAR),YES)
DIRECTIV += -DALL_VISIBLE_INFO_BAR
endif
