...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_Z6W -DFixByQT -DFIX_FORMCONTAINER -DFIX_MENU_2 -DRAISE_PHONE -DCUTED_QT_AND_EZX
TARGET	=       $(APPNAME)_Z6W
endif
...
LINKLIB := -lm -lqte-mt -lezxappbase
DIRECTIV := -DEZX_ZN5 -DFixByQT -DFIX_FORMCONTAINER -DHARD_KEY_DAEMON -DFIX_MENU_2 -DRAISE_PHONE -DCUTED_QT_AND_EZX
TARGET	=       $(APPNAME)_ZN5
endif
